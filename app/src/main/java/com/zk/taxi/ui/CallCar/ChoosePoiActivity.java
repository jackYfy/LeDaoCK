...
public class ChoosePoiActivity extends AppCompatActivity {
    ...
    public static ChoosePoiActivity instance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instance = this;
        RelativeLayout contentView = (RelativeLayout)findViewById(R.id.content_view1);
        ...
        mSearchModuelDeletage.init(getApplicationContext());//获取家和公司地址需要用getApplicationContext
    }
